...
const handleDelete = () => {
    ...
    router.delete(destroy.url({ role: props.row.original.id }), {
        onFinish: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <template v-if="can('roles.editar')">
                <DropdownMenuItem as-child>
                    <Link
                        :href="edit.url({ role: props.row.original.id })"
            ...
            <template v-if="can('roles.eliminar')">
                <DropdownMenuItem
