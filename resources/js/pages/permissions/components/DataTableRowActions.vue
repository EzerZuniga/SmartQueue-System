...
const handleDelete = () => {
    ...
    router.delete(destroy.url({ permission: props.row.original.id }), {
        onFinish: () => {
...
<template>
    <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
            ...
            <template v-if="can('permisos.editar')">
                <DropdownMenuItem as-child>
                    <Link
                        :href="edit.url({ permission: props.row.original.id })"
            ...
            <template v-if="can('permisos.eliminar')">
                <DropdownMenuItem
